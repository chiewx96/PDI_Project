            ...
            modelBuilder.Entity("PDI_Feather_Tracking_API.Models.TareWeightSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ChildCount = 0,
                            CreatedAt = new DateTime(2023, 4, 10, 13, 50, 15, 764, DateTimeKind.Local).AddTicks(688),
                            CreatedBy = 1,
                            UpdatedAt = new DateTime(2023, 4, 10, 13, 50, 15, 764, DateTimeKind.Local).AddTicks(689),
                            UpdatedBy = 1,
                            Weight = 0m
                        });
                });
            ...
            modelBuilder.Entity("PDI_Feather_Tracking_API.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 4, 10, 13, 50, 15, 764, DateTimeKind.Local).AddTicks(603),
                            CreatedBy = 1,
                            EmployeeNo = "SA001",
                            Password = "2yw689CCSPkvtkj6VNBpug==",
                            Status = true,
                            UpdatedAt = new DateTime(2023, 4, 10, 13, 50, 15, 764, DateTimeKind.Local).AddTicks(604),
                            UpdatedBy = 1,
                            UserLevelId = 1,
                            Username = "sysadmin"
                        });
            ...
            modelBuilder.Entity("PDI_Feather_Tracking_API.Models.UserLevel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 4, 10, 13, 50, 15, 762, DateTimeKind.Local).AddTicks(9329),
                            CreatedBy = 1,
                            ...
                            Name = "SysAdmin",
                            Status = true,
                            UpdatedAt = new DateTime(2023, 4, 10, 13, 50, 15, 762, DateTimeKind.Local).AddTicks(9335),
                            UpdatedBy = 1
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2023, 4, 10, 13, 50, 15, 762, DateTimeKind.Local).AddTicks(9337),
                            CreatedBy = 1,
                            Name = "Admin",
                            Status = true,
                            UpdatedAt = new DateTime(2023, 4, 10, 13, 50, 15, 762, DateTimeKind.Local).AddTicks(9337),
                            UpdatedBy = 1
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2023, 4, 10, 13, 50, 15, 762, DateTimeKind.Local).AddTicks(9339),
                            CreatedBy = 1,
                            Name = "Supervisor",
                            Status = true,
                            UpdatedAt = new DateTime(2023, 4, 10, 13, 50, 15, 762, DateTimeKind.Local).AddTicks(9339),
                            UpdatedBy = 1
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2023, 4, 10, 13, 50, 15, 762, DateTimeKind.Local).AddTicks(9340),
                            CreatedBy = 1,
                            Name = "Operator",
                            Status = true,
                            UpdatedAt = new DateTime(2023, 4, 10, 13, 50, 15, 762, DateTimeKind.Local).AddTicks(9341),
                            UpdatedBy = 1
                        });
                });
