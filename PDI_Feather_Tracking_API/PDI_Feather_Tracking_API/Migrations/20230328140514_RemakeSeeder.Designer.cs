...
namespace PDIFeatherTrackingAPI.Migrations
{
    ...
    [Migration("20230328140514_RemakeSeeder")]
    partial class RemakeSeeder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PDI_Feather_Tracking_API.Models.TareWeightSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ChildCount = 0,
                            CreatedAt = new DateTime(2023, 3, 28, 22, 5, 13, 928, DateTimeKind.Local).AddTicks(771),
                            CreatedBy = 1,
                            UpdatedAt = new DateTime(2023, 3, 28, 22, 5, 13, 928, DateTimeKind.Local).AddTicks(772),
                            UpdatedBy = 1,
                            Weight = 0m
                        });
                });
            ...
            modelBuilder.Entity("PDI_Feather_Tracking_API.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 3, 28, 22, 5, 13, 928, DateTimeKind.Local).AddTicks(688),
                            CreatedBy = 1,
                            EmployeeNo = "SA001",
                            Password = "2yw689CCSPkvtkj6VNBpug==",
                            Status = true,
                            UpdatedAt = new DateTime(2023, 3, 28, 22, 5, 13, 928, DateTimeKind.Local).AddTicks(690),
                            UpdatedBy = 1,
                            UserLevelId = 1,
                            Username = "sysadmin"
                        });
            ...
            modelBuilder.Entity("PDI_Feather_Tracking_API.Models.UserLevel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 3, 28, 22, 5, 13, 926, DateTimeKind.Local).AddTicks(7552),
                            CreatedBy = 1,
                            ...
                            Name = "SysAdmin",
                            Status = true,
                            UpdatedAt = new DateTime(2023, 3, 28, 22, 5, 13, 926, DateTimeKind.Local).AddTicks(7559),
                            UpdatedBy = 1
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2023, 3, 28, 22, 5, 13, 926, DateTimeKind.Local).AddTicks(7561),
                            CreatedBy = 1,
                            Name = "Admin",
                            Status = true,
                            UpdatedAt = new DateTime(2023, 3, 28, 22, 5, 13, 926, DateTimeKind.Local).AddTicks(7561),
                            UpdatedBy = 1
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2023, 3, 28, 22, 5, 13, 926, DateTimeKind.Local).AddTicks(7563),
                            CreatedBy = 1,
                            Name = "Supervisor",
                            Status = true,
                            UpdatedAt = new DateTime(2023, 3, 28, 22, 5, 13, 926, DateTimeKind.Local).AddTicks(7563),
                            UpdatedBy = 1
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2023, 3, 28, 22, 5, 13, 926, DateTimeKind.Local).AddTicks(7564),
                            CreatedBy = 1,
                            Name = "Operator",
                            Status = true,
                            UpdatedAt = new DateTime(2023, 3, 28, 22, 5, 13, 926, DateTimeKind.Local).AddTicks(7565),
                            UpdatedBy = 1
                        });
                });
